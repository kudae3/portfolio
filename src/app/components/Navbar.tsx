    ...
    >
      ...
      <div className="block md:hidden relative">
        <button
          ...
          className="text-white hover:text-slate-300 duration-300"
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full right-0 mt-2 w-48 bg-black border border-gray-700 rounded-md shadow-lg">
            <ul className="py-2">
              {NAV_ITEMS.map((item) => (
                <li key={item.id}>
                  <a
