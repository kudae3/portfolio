  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <AnimatedContent>
          <div className="bg-gradient-to-b from-black to-gray-900 border border-gray-800 text-white text-start py-[16px] px-[26px] h-[90px] md:h-[110px] lg:h-[120px] rounded-[20px]">
            <h4 className="text-sm md:text-[15px] lg:text-lg font-semibold mb-2">
              Introdution to Front-end Development
            </h4>
            <div className="text-gray-300 text-xs md:text-[13px]">
        ...
        <AnimatedContent>
          <div className="bg-gradient-to-b from-black to-gray-900 border border-gray-800 text-white text-start py-[16px] px-[26px] h-[90px] md:h-[110px] lg:h-[120px] rounded-[20px]">
            ...
            <div className="text-gray-300 text-xs md:text-[13px]">
              <div className="flex justify-start items-center gap-1 text-green-500 font-extrabold">
                <FaUniversity className="block md:hidden lg:block" />
